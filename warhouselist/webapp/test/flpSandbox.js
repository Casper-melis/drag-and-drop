		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "list",
									"targetURL": "#sapbtpwarhouselist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpwarhouselist-display": {
								"semanticObject": "sapbtpwarhouselist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.warhouselist",
									"url": sap.ui.require.toUrl("sap/btp/warhouselist")
								}
							}
						}
					}
