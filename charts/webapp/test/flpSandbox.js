		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "charts",
									"targetURL": "#sapbtpcharts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpcharts-display": {
								"semanticObject": "sapbtpcharts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.charts",
									"url": sap.ui.require.toUrl("sap/btp/charts")
								}
							}
						}
					}
